...
from solvermind_baselines.baselines.rbfopt_baseline import run_rbfopt
...
def main():
    ...
    best_cfg, best_L, trials_df = run_rbfopt(
        whitelist=wl,
        ...
        epsilon=epsilon,
        N_max=N_max,
        max_evaluations=cfg["rbfopt"]["max_evaluations"],
        seed=cfg["rbfopt"]["seed"],
        out_dir=out_dir,
        tag="rbfopt"
    )
